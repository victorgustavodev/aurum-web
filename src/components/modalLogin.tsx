    ...
    return (
      <div className="bg-black bg-opacity-70 fixed  flex items-center justify-center w-screen h-screen z-10">
        <div className="flex flex-col gap-8 bg-white p-10 rounded-lg min-w-[420px]">
          ...
          <label
            className="flex gap-3 border-b-[1px] border-dark-gray pb-2"
            htmlFor=""
          >
            <User />
            <input
          ...
          <label className="flex gap-3 border-b-[1px] border-dark-gray pb-2">
            <Lock />
            <input
              className="focus:outline-none w-full text-sm"
              type="password"
          ...
          <button className="text-center flex bg-yellow rounded-md text-white h-10 items-center justify-center text-sm">
            Entrar
          </button>
