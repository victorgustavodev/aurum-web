      ...
      <div className="flex flex-col items-center gap-16 lg:flex-row">
        <div className=" lg:w-[560px] flex flex-col gap-5">
          <h1 className="text-2xl lg:text-5xl font-bold">
            Desenvolvimento Web Personalizado para o Sucesso do Seu Negócio
          </h1>
          <p className="text-sm md:text-base lg:text-lg">
            Oferecemos desenvolvimento web personalizado para empreendedores e
            empresas, com foco na abordagem centrada no cliente.
          </p>
        </div>
